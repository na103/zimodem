...
// pin2 accende il led MR Modem Ready
# define DEFAULT_PIN_MR GPIO_NUM_2
...
# define DEFAULT_MR_HIGH  HIGH
# define DEFAULT_MR_LOW  LOW
...
#include "handshake.h" // durata 10.939 sec
#include "busy.h" // durata 4.036 sec
#include "click.h" // durata 0.254 sec
#include "dialing.h" // durata 4.183 sec
...
static int pinMR = DEFAULT_PIN_MR;
...
static int mrActive = DEFAULT_MR_HIGH;
static int mrInactive = DEFAULT_MR_LOW;
...
void setup() 
{
  // crea output e codec il lo creo nella funzione di play in base al suono da riprodurre.
